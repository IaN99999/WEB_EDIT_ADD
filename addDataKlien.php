...
$sql = "INSERT INTO data_klien (id_klien, klasifikasi_perkara, pengadilan, misili_pengadilan, no_perkara, tanggal, agenda) VALUES ('$id_klien', '$klasifikasi_perkara', '$pengadilan', '$misili_pengadilan', '$no_perkara', '$tanggal', '$agenda')";
